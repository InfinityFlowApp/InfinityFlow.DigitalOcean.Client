...
#nullable enable
        public List<global::InfinityFlow.DigitalOcean.Client.Models.Domain_record>? DomainRecords { get; set; }
#nullable restore
#else
        public List<global::InfinityFlow.DigitalOcean.Client.Models.Domain_record> DomainRecords { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::InfinityFlow.DigitalOcean.Client.V2.Domains.Item.Records.RecordsGetResponse"/> and sets the default values.
        /// </summary>
        ...
        public static global::InfinityFlow.DigitalOcean.Client.V2.Domains.Item.Records.RecordsGetResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::InfinityFlow.DigitalOcean.Client.V2.Domains.Item.Records.RecordsGetResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "domain_records", n => { DomainRecords = n.GetCollectionOfObjectValues<global::InfinityFlow.DigitalOcean.Client.Models.Domain_record>(global::InfinityFlow.DigitalOcean.Client.Models.Domain_record.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::InfinityFlow.DigitalOcean.Client.Models.Domain_record>("domain_records", DomainRecords);
