...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::InfinityFlow.DigitalOcean.Client.Models.Repository_tag>? Tags { get; set; }
#nullable restore
#else
        public List<global::InfinityFlow.DigitalOcean.Client.Models.Repository_tag> Tags { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::InfinityFlow.DigitalOcean.Client.V2.Registry.Item.Repositories.Item.Tags.TagsGetResponse"/> and sets the default values.
        /// </summary>
        ...
        public static global::InfinityFlow.DigitalOcean.Client.V2.Registry.Item.Repositories.Item.Tags.TagsGetResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::InfinityFlow.DigitalOcean.Client.V2.Registry.Item.Repositories.Item.Tags.TagsGetResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "tags", n => { Tags = n.GetCollectionOfObjectValues<global::InfinityFlow.DigitalOcean.Client.Models.Repository_tag>(global::InfinityFlow.DigitalOcean.Client.Models.Repository_tag.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::InfinityFlow.DigitalOcean.Client.Models.Repository_tag>("tags", Tags);
