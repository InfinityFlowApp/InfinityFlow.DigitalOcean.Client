...
using System;
namespace InfinityFlow.DigitalOcean.Client.V2.Cdn.Endpoints.Item.Cache
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::InfinityFlow.DigitalOcean.Client.V2.Cdn.Endpoints.Item.Cache.CacheRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task DeleteAsync(global::InfinityFlow.DigitalOcean.Client.Models.Purge_cache body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task DeleteAsync(global::InfinityFlow.DigitalOcean.Client.Models.Purge_cache body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToDeleteRequestInformation(global::InfinityFlow.DigitalOcean.Client.Models.Purge_cache body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToDeleteRequestInformation(global::InfinityFlow.DigitalOcean.Client.Models.Purge_cache body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::InfinityFlow.DigitalOcean.Client.V2.Cdn.Endpoints.Item.Cache.CacheRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::InfinityFlow.DigitalOcean.Client.V2.Cdn.Endpoints.Item.Cache.CacheRequestBuilder WithUrl(string rawUrl)
        {
            return new global::InfinityFlow.DigitalOcean.Client.V2.Cdn.Endpoints.Item.Cache.CacheRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
