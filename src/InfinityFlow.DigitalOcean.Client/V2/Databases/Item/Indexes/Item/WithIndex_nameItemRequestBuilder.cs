...
using System;
namespace InfinityFlow.DigitalOcean.Client.V2.Databases.Item.Indexes.Item
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::InfinityFlow.DigitalOcean.Client.V2.Databases.Item.Indexes.Item.WithIndex_nameItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::InfinityFlow.DigitalOcean.Client.V2.Databases.Item.Indexes.Item.WithIndex_nameItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::InfinityFlow.DigitalOcean.Client.V2.Databases.Item.Indexes.Item.WithIndex_nameItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
