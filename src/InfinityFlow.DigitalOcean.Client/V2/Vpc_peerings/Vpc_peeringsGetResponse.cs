...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::InfinityFlow.DigitalOcean.Client.Models.Vpc_peering>? VpcPeerings { get; set; }
#nullable restore
#else
        public List<global::InfinityFlow.DigitalOcean.Client.Models.Vpc_peering> VpcPeerings { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::InfinityFlow.DigitalOcean.Client.V2.Vpc_peerings.Vpc_peeringsGetResponse"/> and sets the default values.
        /// </summary>
        ...
        public static global::InfinityFlow.DigitalOcean.Client.V2.Vpc_peerings.Vpc_peeringsGetResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::InfinityFlow.DigitalOcean.Client.V2.Vpc_peerings.Vpc_peeringsGetResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "vpc_peerings", n => { VpcPeerings = n.GetCollectionOfObjectValues<global::InfinityFlow.DigitalOcean.Client.Models.Vpc_peering>(global::InfinityFlow.DigitalOcean.Client.Models.Vpc_peering.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::InfinityFlow.DigitalOcean.Client.Models.Vpc_peering>("vpc_peerings", VpcPeerings);
