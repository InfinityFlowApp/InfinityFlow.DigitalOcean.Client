...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::InfinityFlow.DigitalOcean.Client.Models.SshKeys>? SshKeys { get; set; }
#nullable restore
#else
        public List<global::InfinityFlow.DigitalOcean.Client.Models.SshKeys> SshKeys { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::InfinityFlow.DigitalOcean.Client.V2.Account.Keys.KeysGetResponse"/> and sets the default values.
        /// </summary>
        ...
        public static global::InfinityFlow.DigitalOcean.Client.V2.Account.Keys.KeysGetResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::InfinityFlow.DigitalOcean.Client.V2.Account.Keys.KeysGetResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "ssh_keys", n => { SshKeys = n.GetCollectionOfObjectValues<global::InfinityFlow.DigitalOcean.Client.Models.SshKeys>(global::InfinityFlow.DigitalOcean.Client.Models.SshKeys.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::InfinityFlow.DigitalOcean.Client.Models.SshKeys>("ssh_keys", SshKeys);
