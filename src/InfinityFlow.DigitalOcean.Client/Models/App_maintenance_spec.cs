...
namespace InfinityFlow.DigitalOcean.Client.Models
{
    ...
    public partial class App_maintenance_spec : IAdditionalDataHolder, IParsable
    {
        ...
        /// <summary>Indicates whether the app should be archived. Setting this to true implies that enabled is set to true. Note that this feature is currently in closed beta.</summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::InfinityFlow.DigitalOcean.Client.Models.App_maintenance_spec"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::InfinityFlow.DigitalOcean.Client.Models.App_maintenance_spec CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::InfinityFlow.DigitalOcean.Client.Models.App_maintenance_spec();
        }
        /// <summary>
