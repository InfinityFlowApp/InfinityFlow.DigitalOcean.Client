...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::InfinityFlow.DigitalOcean.Client.Models.Alert_policy_request"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::InfinityFlow.DigitalOcean.Client.Models.Alert_policy_request"/></returns>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "compare", n => { Compare = n.GetEnumValue<global::InfinityFlow.DigitalOcean.Client.Models.Alert_policy_request_compare>(); } },
                { "description", n => { Description = n.GetStringValue(); } },
                { "enabled", n => { Enabled = n.GetBoolValue(); } },
                { "entities", n => { Entities = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
                { "tags", n => { Tags = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
                { "type", n => { Type = n.GetEnumValue<global::InfinityFlow.DigitalOcean.Client.Models.Alert_policy_request_type>(); } },
                { "value", n => { Value = n.GetFloatValue(); } },
                { "window", n => { Window = n.GetEnumValue<global::InfinityFlow.DigitalOcean.Client.Models.Alert_policy_request_window>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::InfinityFlow.DigitalOcean.Client.Models.Alert_policy_request_compare>("compare", Compare);
            writer.WriteStringValue("description", Description);
            writer.WriteBoolValue("enabled", Enabled);
            writer.WriteCollectionOfPrimitiveValues<string>("entities", Entities);
            writer.WriteCollectionOfPrimitiveValues<string>("tags", Tags);
            writer.WriteEnumValue<global::InfinityFlow.DigitalOcean.Client.Models.Alert_policy_request_type>("type", Type);
            writer.WriteFloatValue("value", Value);
            writer.WriteEnumValue<global::InfinityFlow.DigitalOcean.Client.Models.Alert_policy_request_window>("window", Window);
